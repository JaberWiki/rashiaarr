                            ...
                            <div class="card-body">
                                <div class="form-validation">
                                    ...
                                    <form class="form-valide" action="{{ route('admin.stockout.store') }}" method="post">
                                      ...
                                      <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-category">Stock Out<span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" name="stock" placeholder="Add Stock out Number">
                                            </div>
                                        </div>
