                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    ...
                                    <form class="form-valide" action="{{ url('admin/branch/update/'.$data->id) }}" method="post">
                                    	@csrf
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" name="branch_name" value="{{ $data->branch_name }}" placeholder="Enter Branch Name.">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" name="branch_address" value="{{ $data->branch_address }}" placeholder="Enter Branch Address.">
                                            </div>
                                        </div>
                                       ...
                                       <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" name="location" value="{{ $data->location }}" placeholder="Enter Branch Location.">
                                            </div>
                                        </div>
